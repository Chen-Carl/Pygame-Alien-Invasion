...
def update_screen(ai_settings, screen, sb, ship, aliens, bullets, stats,
                  play_button):
...
def get_number_rows(ai_settings, ship_height, alien_height):
    avaliabel_space_y = (ai_settings.screen_height - 3 * alien_height -
                         ship_height)
    number_rows = int(avaliabel_space_y / (2 * alien_height))
    return number_rows
